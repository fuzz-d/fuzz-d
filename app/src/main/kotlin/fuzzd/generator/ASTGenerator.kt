...
interface ASTGenerator {
    ...
    fun generateSequence(context: GenerationContext, noStatements: Int): SequenceAST
    ...
    fun generateForLoopStatement(context: GenerationContext): List<StatementAST>
    ...
    fun generateSequenceComprehension(
        context: GenerationContext,
